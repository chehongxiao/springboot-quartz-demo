...
public interface IAppQuartzMapper {
    ...
    @Select("SELECT t.quartz_id as quartzId,t.job_name as jobName,t.job_group as jobGroup,t.cron_expression as cronExpression,t.invoke_param as invokeParam,t.start_time as startTime FROM app_quartz t")
